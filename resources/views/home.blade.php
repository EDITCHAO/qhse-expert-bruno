...
<nav class="navbar">
    <div class="container">
        ...
        <a href="{{ route('admin.login') }}" class="admin-btn"><i class="fas fa-user-shield"></i> Admin</a>
    </div>
</nav>
        ...
        <div class="about-grid">
            <div class="about-image-container">
                <div class="about-image">
                    <img src="{{ asset('images/atayi-bruno.jpeg') }}" alt="Atayi Bruno - Responsable QHSE">
                </div>
            </div>
...
<footer class="footer">
    <div class="container">
        ...
        <div class="footer-bottom">
            <p>&copy; {{ date('Y') }} QHE Excellence. Tous droits réservés.</p>
        </div>
    </div>
</footer>
