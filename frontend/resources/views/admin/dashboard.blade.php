    ...
    <div class="dashboard-container">
        ...
        <div class="stats-grid">
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3>Aujourd'hui</h3>
                    <p>{{ $contacts->where('created_at', '>=', now()->startOfDay())->count() }}</p>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3>Cette Semaine</h3>
                    <p>{{ $contacts->where('created_at', '>=', now()->startOfWeek())->count() }}</p>
                </div>
            </div>
            ...
            <div class="stat-card">
                ...
                <div class="stat-info">
                    <h3>Ce Mois</h3>
                    <p>{{ $contacts->where('created_at', '>=', now()->startOfMonth())->count() }}</p>
                </div>
            </div>
        </div>
